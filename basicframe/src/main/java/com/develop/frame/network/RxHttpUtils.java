...
import com.develop.frame.network.download.DownloadRetrofit;
import com.develop.frame.network.http.GlobalRxHttp;
import com.develop.frame.network.http.SingleRxHttp;
import com.develop.frame.network.upload.UploadRetrofit;
...
public class RxHttpUtils {
    ...
    public static HashSet<String> getCookie() {
        ...
        //TODO :
       /* HashSet<String> preferences = (HashSet<String>) SPUtil.getInstalnc().get(SPKeys.COOKIE, new HashSet<String>());
        return preferences;*/
       return null;
    }
