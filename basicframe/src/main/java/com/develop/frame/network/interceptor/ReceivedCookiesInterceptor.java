...
public class ReceivedCookiesInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
       ...
       Log.d("Http Response","Response Code="+ originalResponse.code());
