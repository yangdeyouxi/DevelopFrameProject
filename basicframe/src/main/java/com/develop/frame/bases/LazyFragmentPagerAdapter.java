...
public abstract class LazyFragmentPagerAdapter extends PagerAdapter {
    ...
    public void startUpdate(ViewGroup container){
        if (container.getId() == View.NO_ID){
            throw new IllegalStateException("ViewPager with adpater"+this+
            "requires a view id");
        }
    }
    @Override
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragment != null) {
            Logger.t(TAG).d( "Attaching item #" + itemId + ": f=" + fragment);
            mCurTransaction.show(fragment);
        } else {
            fragment = getItem(position);
            Logger.t(TAG).d( "Adding item #" + itemId + ": f=" + fragment);
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        Logger.t(TAG).d( "Detaching item #" + getItemId(position) + ": f=" + object
    ...
    public void setmCurrentPrimaryItem(Fragment mCurrentPrimaryItem) {
