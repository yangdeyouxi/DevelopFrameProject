...
public final class ActivityUtils {
    ...
    public  static Application.ActivityLifecycleCallbacks mLifeCycleCallbacks
    ...
    public static Activity getTopActivity() {
        ...
        List<Activity> activities = mActivityList;
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = mActivityList;
